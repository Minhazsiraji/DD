...
select public.test_assert((select count(*)=1 from public.staff_get_queue('20000000-0000-0000-0000-000000000001',(select session_date from public.appointments where id=:'managed_appointment_id')) where owner_doctor_id='10000000-0000-0000-0000-000000000001'), 'managed queue returns Doctor A row');
select public.test_assert((select count(*)=0 from public.staff_get_queue('20000000-0000-0000-0000-000000000001',(select session_date from public.appointments where id=:'managed_appointment_id')) where owner_doctor_id='10000000-0000-0000-0000-000000000002'), 'Doctor B queue row excluded at shared location');
