  ...
  return (
    <li>
      <Link
        ...
        title={item.label}
        className={cn(
          "group flex min-h-12 items-center gap-3 rounded-[16px] border border-transparent px-3 py-2.5 text-[14px] font-medium transition-[background,border-color,color,box-shadow,transform] duration-150 focus-visible:focus-ring",
          "lg:justify-center xl:justify-start",
          active
            ? "dd-nav-selected liquid-nav-active text-brand"
            : "text-ink-secondary hover:-translate-y-px hover:bg-white/55 hover:text-ink",
        )}
      >
