...
/**
 * Doctor Pilot mobile navigation — exactly the four locked destinations:
 * Today · Patients · Appointments · More.
 *
 * Hidden during consultation because the clinical workflow owns the bottom
 * action area and accidental navigation is especially costly there.
 */
      ...
      <Link
        ...
        className={cn(
          ...
          active
            ...
            : "text-ink-muted hover:bg-white/65 hover:text-ink-secondary",
        )}
      >
        <span aria-hidden="true">{icon}</span>
        <span className="w-full truncate text-center text-[12px] leading-none font-medium">
          {label}
        </span>
      </Link>
    </li>
