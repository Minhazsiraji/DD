...
export function StatCard({
  ...
  if (href) {
    return (
      <GlassCard
        interactive
        className={cn("dd-dashboard-card w-full min-w-0 focus-within:focus-ring p-4 sm:p-5", className)}
      >
  ...
  return <GlassCard className={cn("dd-dashboard-card w-full min-w-0 p-4 sm:p-5", className)}>{body}</GlassCard>;
}
