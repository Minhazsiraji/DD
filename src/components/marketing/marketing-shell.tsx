...
export function MarketingShell({ children }: { children: ReactNode }) {
  return (
    <div className="liquid-public-shell min-h-screen text-ink">
      <header className="sticky top-0 z-40 px-4 pt-4 sm:px-6 lg:px-8">
        <div className="liquid-public-header mx-auto flex max-w-7xl items-center justify-between gap-4 rounded-[28px] px-4 py-3 sm:px-5">
          <Link href="/" className="flex min-w-0 items-center gap-3 rounded-2xl focus-visible:focus-ring">
            ...
            <span className="min-w-0">
              ...
              <span className="mt-1 block truncate text-[10px] font-medium uppercase tracking-[0.16em] text-[#77708f]">
                Care · Record · Connect
              </span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/login"
              className="liquid-secondary hidden h-10 items-center rounded-full px-4 text-[13px] font-semibold text-[#4d4669] sm:inline-flex"
            >
              Sign in
            </Link>
            <Link
              href="/signup"
              className="liquid-primary inline-flex h-10 items-center rounded-full px-4 text-[13px] font-semibold text-white sm:h-11 sm:px-5"
            >
              Start free
            </Link>
          </div>
      ...
      <footer className="px-4 pb-5 pt-10 sm:px-6 lg:px-8">
        <div className="liquid-public-footer mx-auto grid max-w-7xl gap-8 rounded-[28px] px-5 py-7 text-[13px] text-ink-secondary md:grid-cols-[1.6fr_1fr_1fr] sm:px-7">
          <div>
    ...
    <MarketingShell>
      <section className="mx-auto max-w-7xl px-5 pb-20 pt-16 lg:px-8 lg:pt-20">
        <div className="max-w-3xl">
          <p className="inline-flex rounded-full border border-white/70 bg-white/46 px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.16em] text-[#6655cf] shadow-[inset_0_1px_0_white]">
            {eyebrow}
          </p>
