...
export function PublicGlassHeader() {
  return (
  ...
  return (
    <div className="min-h-screen text-ink">
      ...
      <footer className="px-3 pb-4 pt-8 sm:px-5 lg:px-7">
        <div className="dd-approved-stage dd-lower-wide-stage mx-auto max-w-7xl">
          <span className="dd-approved-light" aria-hidden />
          <div className="dd-public-footer dd-approved-slab dd-lower-approved">
            <span className="dd-approved-glows" aria-hidden />
            <span className="dd-approved-contour" aria-hidden />
            <div className="dd-approved-content grid gap-6 px-4 py-5 text-[12.5px] text-ink-secondary sm:px-6 md:grid-cols-[1.6fr_1fr_1fr]">
              <div>
