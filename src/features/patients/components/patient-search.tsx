  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="dd-input h-12 w-full rounded-full pr-12 pl-11 text-base text-ink placeholder:text-ink-muted focus-visible:focus-ring"
      />
      ...
      {pending ? (
        ...
        <button
          ...
          className="dd-icon-btn absolute top-1/2 right-2 flex size-9 -translate-y-1/2 items-center justify-center rounded-full text-ink-muted hover:text-brand focus-visible:focus-ring"
        >
