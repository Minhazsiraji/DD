  ...
  return (
    <div className="space-y-1.5">
      ...
      <input
        ...
        className={cn(
          "liquid-input h-12 w-full rounded-[17px] px-4 text-sm text-ink placeholder:text-ink-muted focus-visible:focus-ring",
...
export function SubmitButton({ children }: { children: React.ReactNode }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="liquid-primary inline-flex h-12 w-full items-center justify-center gap-2 rounded-full px-5 text-sm font-semibold text-white transition-[transform,filter,box-shadow] duration-150 disabled:cursor-not-allowed disabled:opacity-60 focus-visible:focus-ring"
    >
      {pending ? (
        <>
  ...
  return (
    <p
      ...
      className={cn(
        ...
        state.ok ? "bg-success-soft text-[#087a62]" : "bg-danger-soft text-[#b63745]",
      )}
    >
...
export function AuthCard({
  ...
  return (
    <div className="liquid-auth-card rounded-[25px] p-6 shadow-raised sm:p-7">
