...
/** Generic draft-only control. PA1-C1 does not wire this into clinical UI. */
    ...
    >
      ...
      {state === "listening" && (
        <p className="mt-1.5 text-[11px] text-ink-muted">
          {providerNotice} Speech appears here only as an editable draft; this control has no clinical write authority.
        </p>
      )}
    </div>
  );
