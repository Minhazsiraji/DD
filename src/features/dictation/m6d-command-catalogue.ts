...
export type M6DHelpCategory = "Navigate" | "Dictate" | "Edit" | "Control" | "Target-specific";

const NOTE_HELP: readonly [M6DHelpCategory, readonly string[]][] = [
  ["Navigate", ["Follow-up", "Diagnosis"]],
  ["Dictate", ["Patient has fever for three days"]],
  ["Edit", ["Replace fever with cough", "Clear this section"]],
  ["Control", ["Pause", "End voice"]],
];

export function getM6DVoiceHelpExamples(section: string): readonly [M6DHelpCategory, readonly string[]][] {
  if (section === "nextVisitNote") {
    return [
      ["Target-specific", ["Tomorrow", "2 weeks", "Follow-up in 2 weeks"]],
      ["Dictate", ["With reports"]],
      ["Edit", ["Replace with reports with after treatment", "Clear this section"]],
      ["Control", ["Pause", "End voice"]],
    ];
  }
  if (section === "diagnoses") {
    return [
      ["Target-specific", ["Diagnosis field", "How certain", "Confirmed", "Diagnosis note"]],
      ["Dictate", ["Dengue fever", "Platelets falling, review tomorrow"]],
      ["Edit", ["Undo", "Clear this field"]],
      ["Control", ["Pause", "End voice"]],
    ];
  }
  if (section === "investigations") {
    return [
      ["Target-specific", ["Investigation field", "CBC and lipid profile"]],
