  ...
  return (
    <MarketingShell>
      <section className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-16 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:pb-28 lg:pt-24">
        ...
        <div className="dd-bg-exposure-panel rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_24px_80px_rgba(15,23,42,.08)] sm:p-7">
          <div className="dd-bg-exposure-inner rounded-3xl bg-[#edf4ff] p-6">
      ...
      <section className="dd-bg-exposure-section border-y border-slate-200 bg-white">
