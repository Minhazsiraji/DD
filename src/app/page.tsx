    ...
    <MarketingShell>
      <section className="mx-auto grid max-w-7xl gap-12 px-5 pb-20 pt-16 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:pb-28 lg:pt-24">
        <div className="self-center">
          <p className="dd-material-record dd-record-pearl inline-flex rounded-full border border-teal-200 bg-teal-50 px-3 py-1 text-sm font-medium text-brand">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/signup" className="dd-primary inline-flex min-h-11 items-center rounded-xl bg-teal-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-teal-700 focus-visible:focus-ring">
              Start free
            </Link>
            <Link href="/pricing" className="dd-secondary inline-flex min-h-11 items-center rounded-xl border border-slate-300 bg-white px-5 py-3 text-sm font-semibold text-slate-800 transition hover:bg-slate-50 focus-visible:focus-ring">
              See founding plan
            </Link>
          </div>
        ...
        <div className="dd-app-panel dd-material-panel dd-panel-pearl dd-public-card rounded-[2rem] border border-slate-200 bg-white p-5 shadow-[0_24px_80px_rgba(15,23,42,.08)] sm:p-7">
          <div className="rounded-3xl bg-white/10 p-6">
            <div className="flex items-center justify-between">
              ...
              <span className="dd-material-record dd-record-pearl rounded-full bg-white px-3 py-1 text-xs font-medium text-brand">Private clinical workspace</span>
            </div>
            <div className="mt-6 grid gap-3">
              {workflow.map((item, i) => (
                <div key={item} className="dd-quick-control flex items-center gap-3 rounded-2xl bg-white px-4 py-3 text-sm text-slate-700 shadow-sm">
      ...
      <section className="border-y border-white/45">
        <div className="mx-auto grid max-w-7xl gap-5 px-5 py-16 md:grid-cols-3 lg:px-8">
          {benefits.map((benefit) => (
            <article key={benefit.title} className="dd-material-record dd-record-pearl dd-public-feature-card rounded-3xl border border-slate-200 bg-[#fbfdff] p-6">
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
        <div className="dd-material-panel dd-panel-pearl rounded-[2rem] bg-slate-950 px-6 py-10 text-ink sm:px-10 lg:flex lg:items-center lg:justify-between">
          <div>
          ...
          <Link href="/pricing" className="dd-secondary mt-6 inline-flex min-h-11 items-center rounded-xl bg-white px-5 py-3 text-sm font-semibold text-slate-950 focus-visible:focus-ring lg:mt-0">
            View the plan
          </Link>
        </div>
      </section>
