  ...
  return (
    <MarketingPage eyebrow="Founding Doctor" title="Start with the product. Prove the value. Then pay to keep it." intro="Exact paid pricing will be finalized from pilot evidence. The commercial model is intentionally configurable instead of hard-coding an unvalidated number into the product.">
      <div className="grid gap-6 lg:grid-cols-[1fr_.8fr]">
        <article className="dd-material-panel dd-panel-pearl rounded-[2rem] p-7">
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <span className="dd-material-record dd-record-pearl rounded-full px-3 py-1 text-xs font-semibold text-brand">Pilot → paid transition</span>
          </div>
          ...
          <ul className="mt-6 grid gap-3 text-sm text-ink-secondary sm:grid-cols-2">
            {included.map((item) => <li key={item} className="dd-material-record dd-record-pearl rounded-xl px-4 py-3">✓ {item}</li>)}
          </ul>
        ...
        <aside className="dd-material-panel dd-panel-pearl rounded-[2rem] p-7 text-ink">
